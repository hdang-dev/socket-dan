...
export function Menu() {
  ...
  return (
    <>
      <div className="w-full h-full overflow-y-scroll scrollbar-none scroll-smooth">
        <div className="w-full h-fit flex flex-col pt-[80px] md:pt-[100px]">
      ...
      <div className="hidden w-full h-full overflow-scroll snap-x snap-mandatory scrollbar-none scroll-smooth">
